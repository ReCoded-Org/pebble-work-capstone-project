    ...
    return (
        <>
            <div className='flex flex-col items-center justify-center gap-6 md:flex-row'>
                ...
                <div className='mx-4 flex w-96 flex-col justify-center py-1 text-center'>
                    <h2 className='py-1 font-semibold md:flex'>{title}</h2>
                    <div className='w-full '>
                        ...
                        <div className='flex justify-center py-1'>
                            <button className=' flex w-96 flex-row items-center justify-center rounded border-2 border-b-4  border-black bg-transparent py-1 font-normal text-black hover:border-transparent hover:border-primary-200 hover:text-primary-200'>
                                <svg
                                    width='30'
                                    height='30'
                                    viewBox='0 0 41 36'
                        ...
                        <div className='flex justify-center py-1'>
                            <button className='border-1 m-1  flex w-96 flex-row items-center justify-center rounded border-2 border-b-4   border-black bg-transparent py-1 font-normal text-black hover:border-transparent hover:border-primary-200 hover:text-primary-200'>
                                <svg
                                    width='30'
                                    height='30'
                                    viewBox='0 0 44 39'
