...
function EventBanner({title, imageSrc, city, neighborhood, address, attendees, host}) {
  ...
  return (
      <div className="grid grid-col-1 md:grid-cols-3 grid-flow-row gap-2 md:gap-10 md:pl-6">
          ...
          <div className="flex flex-col justify-items-start justify-self-center md:items-start col-span-1 p-6 md:pt-48 order-last">
            <div className="flex">
              <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M21.0001 3.5C13.2809 3.5 7.00014 9.78075 7.00014 17.4913C6.94939 28.77 20.4681 38.122 21.0001 38.5C21.0001 38.5 35.0509 28.77 35.0001 17.5C35.0001 9.78075 28.7194 3.5 21.0001 3.5ZM21.0001 24.5C17.1326 24.5 14.0001 21.3675 14.0001 17.5C14.0001 13.6325 17.1326 10.5 21.0001 10.5C24.8676 10.5 28.0001 13.6325 28.0001 17.5C28.0001 21.3675 24.8676 24.5 21.0001 24.5Z" fill="black"/>
              </svg>
              <div>
                <p><b>{city}</b></p>           
                <p>{neighborhood}</p>
            ...
            <button className="bg-primary-200 rounded w-48 h-12">Join</button>
          </div>
        </div>
  )
